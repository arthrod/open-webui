...
<!-- Header -->
<div
	class="fixed w-full h-20 px-48 py-3 flex items-center justify-between bg-white/90 border-b-[2px] border-gray-100 z-50"
>
	<img
	...
	/>
	<button
		class="h-full px-12 rounded-full border border-black bg-white hover:bg-gray-50 transition-all"
	>
		Contact us
	</button>
</div>
...
<div class="h-screen overflow-y-scroll pt-20 text-gray-700">
	<div class="grid grid-cols-2">
		<div class="p-48 flex flex-col justify-center space-y-6 bg-slate-100">
			<span class="text-5xl">
				LUCIE : The truly open source AI built on transparency, trust, and efficiency.
			</span>
			<span class="text-lg pr-32">
			...
			{#if queueStatus.status === 'disconnected'}
				<button
					class="h-16 w-64 rounded-full bg-blue-500 hover:bg-blue-400 text-white font-medium transition-all"
			...
			{:else if queueStatus.status === 'connected'}
				<div
					class="h-16 w-64 flex items-center justify-center gap-3 text-lg sm:text-lg text-center font-semibold dark:text-gray-200"
				>
					<div>
			...
			{:else if queueStatus.status === 'waiting'}
				<button
					class="h-16 w-64 rounded-full bg-slate-400 font-medium transition-all relative"
					disabled
				>
					...
					>
					<span class="absolute left-full w-full text-xs">
			...
			{:else if queueStatus.status === 'draft'}
				<button
					class="h-16 w-64 rounded-full bg-emerald-500 hover:bg-emerald-400 text-white font-medium transition-all"
	...
	<!-- Logos -->
	<div class="px-48 flex items-center justify-between py-8">
		<img
			crossorigin="anonymous"
		...
		/>
		<img crossorigin="anonymous" src="/assets/logos/opsci.png" class="h-16" alt="OPSCI logo" />
		<img
			crossorigin="anonymous"
	...
	<div class="px-48 my-24">
		<div class="text-3xl mb-16">What makes LUCIE truly Open Source ?</div>
		<div class="grid grid-cols-3 gap-24 px-6">
			<div class="flex flex-col space-y-8">
				<EyeInBox className="size-8" />
				<span class="text-2xl font-medium">Transparent Data</span>
				<span>
			...
			<div class="flex flex-col space-y-8">
				...
				<span class="text-2xl font-medium">Open Algorithms</span>
				<span>
			...
			<div class="flex flex-col space-y-8">
				...
				<span class="text-2xl font-medium">Freely Accessible Models</span>
				<span>
	...
	<div class="px-48 py-24 bg-gray-50">
		<div class="grid grid-cols-2 items-center mb-16">
			<span class="text-3xl"> Designed for sovereignty and sustainability </span>
			<span>
		...
		<div class="grid grid-cols-3 gap-6">
			<div class="flex flex-col space-y-8 bg-white rounded p-8">
				<EuLogo className="size-16 p-1 border-2 border-gray-700 rounded-full" />
				<span class="text-3xl font-medium">European Sovereignty</span>
				<span>
			...
			<div class="flex flex-col space-y-8 bg-white rounded p-8">
				...
				<span class="text-3xl font-medium">Compact and Efficient</span>
				<span>
			...
			<div class="flex flex-col space-y-8 bg-white rounded p-8">
				...
				<span class="text-3xl font-medium">Eco-Responsibility</span>
				<span>
	...
	<div class="px-48 my-24">
		<div class="text-3xl mb-16">LUCIE in figures</div>
		<div class="grid grid-cols-5 gap-24">
			<div class="flex flex-col space-y-6">
				<span class="text-3xl h-20">7 billion parameters</span>
			...
			<div class="flex flex-col space-y-6">
				<span class="text-3xl h-20">3.1 trillion tokens</span>
				<div class="w-full h-px bg-black"></div>
				<span>
			...
			<div class="flex flex-col space-y-6">
				<span class="text-3xl h-20">600k GPU Hours</span>
				<div class="w-full h-px bg-black"></div>
				<span>
			...
			<div class="flex flex-col space-y-6">
				<span class="text-3xl h-20">Languages supported</span>
				<div class="w-full h-px bg-black"></div>
				<span>
			...
			<div class="flex flex-col space-y-6">
				<span class="text-3xl h-20">2023 - 2025</span>
				<div class="w-full h-px bg-black"></div>
				<span>
	...
	<div class="py-24 bg-gray-50 flex flex-col items-center text-center">
		<div class="text-3xl mb-8">Future of LUCIE in 2025</div>
		<div class="px-[33vw] mb-16">
		...
		<div class="px-[25vw] -translate-x-44">
			<Timeline>
				<TimelineItem>
					<TimelineOppositeContent slot="opposite-content">
						<span class="font-bold text-xl">Q1</span>
					</TimelineOppositeContent>
					<TimelineSeparator>
					...
					<TimelineContent>
						<div class="flex flex-col space-y-2 pb-12">
							<span class="text-2xl"> Enhanced fine-tuning and better toolkit for AI makers </span>
							<span>
				...
				<TimelineItem>
					<TimelineOppositeContent slot="opposite-content">
						<span class="font-bold text-xl">Q2</span>
					</TimelineOppositeContent>
					<TimelineSeparator>
						<TimelineDot />
						<TimelineConnector />
					...
					<TimelineContent>
						<div class="flex flex-col space-y-2 pb-12">
							<span class="text-2xl"> Advanced Retrieval-Augmented Generation (RAG) </span>
							<span>
				...
				<TimelineItem>
					<TimelineOppositeContent slot="opposite-content">
						<span class="font-bold text-xl">Q3</span>
					</TimelineOppositeContent>
					<TimelineSeparator>
						<TimelineDot />
						<TimelineConnector />
					...
					<TimelineContent>
						<div class="flex flex-col space-y-2 pb-12">
							<span class="text-2xl"> Multimodal Expansion with Voice Support </span>
							<span>
				...
				<TimelineItem>
					<TimelineOppositeContent slot="opposite-content">
						<span class="font-bold text-xl">Q4</span>
					</TimelineOppositeContent>
					<TimelineSeparator>
						<TimelineDot />
						<TimelineConnector />
					...
					<TimelineContent>
						<div class="flex flex-col space-y-2">
							<span class="text-2xl"> Agentic AI Framework </span>
							<span>
	...
	<div class="px-48 py-24">
		<div class="grid grid-cols-2 gap-12 items-center mb-16">
			<span class="text-3xl"> Join the LUCIE movement </span>
		...
		<div class="grid grid-cols-4 gap-8">
			<div class="flex flex-col space-y-4 bg-white rounded border pb-8">
				<div
					class="h-96 p-8 flex justify-center bg-[url('/assets/design/abstract-circle.png')] bg-contain bg-no-repeat"
				>
					<img
						crossorigin="anonymous"
				...
				<span class="h-16 px-8 text-2xl"> Collaborate on GitHub </span>
				<span class="px-8 text-sm h-32"> Contribute to LUCIE's development. </span>
				<a
			...
			<div class="flex flex-col space-y-4 bg-white rounded border pb-8">
				...
				<span class="h-16 px-8 text-2xl"> Experiment on Hugging Face </span>
				<span class="px-8 text-sm h-32">
					LUCIE embodies a commitment to European values, respecting cultural diversity, promoting
					ethical AI, development and compliance with AI Act.
				</span>
				<a
			...
			<div class="flex flex-col space-y-4 bg-white rounded border pb-8">
				...
				<span class="h-16 px-8 text-2xl"> Be Part of OpenLLM France </span>
				<span class="px-8 text-sm h-32">
			...
			<div class="flex flex-col space-y-4 bg-white rounded border pb-8">
				...
				<span class="h-16 px-8 text-2xl"> Other European Initiatives </span>
				<span class="px-8 text-sm h-32"> Explore other european OpenLLM projects. </span>
				<a
	...
	<div class="px-48 flex flex-col items-center space-y-6 mb-8">
